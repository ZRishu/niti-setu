        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {recsLoading ? (
            ...
            <div className="bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200 py-16 text-center space-y-4">
              ...
              <Link 
                to="/profile"
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-700 transition-all shadow-lg shadow-primary-100"
              >
                Update Profile
              </Link>
            </div>
