    ...
    <nav className="bg-white shadow-md border-b border-gray-100 sticky top-0 z-50">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              className={`${isOpen ? 'text-black' : 'text-slate-500'} hover:text-slate-700 focus:outline-none p-2 z-50`}
            >
      ...
      {isOpen && (
        <>
          ...
          <div className="md:hidden absolute top-16 left-0 right-0 bg-white border-b border-gray-100 shadow-lg animate-in slide-in-from-top duration-200 z-50">
